            ...
            <div class="col-xs-12">
                <div class="box box-danger">
                    <div class="box-header">
                        <h3 class="box-title">Data Penegakan Hukum</h3>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('user.laporanKegiatan') }}" method="post" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="jenisKegiatan" class="form-control" value="Penegakan Hukum">
                        <div class="row">
    ...
    <div class="modal fade" id="modal-form-tambah-kegiatan" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Form Tambah Data Penegakan Hukum</h4>
                </div>
                <div class="modal-body">
                    <form action="{{ route('user.add_kegiatan') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input type="hidden" name="jenis_kegiatan" class="form-control" value="Penegakan Hukum"
                                readonly>
                        </div>
                        <div class="form-group has-feedback">
